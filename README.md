...
Дополнительные графопостроители: 
* Распределение электронной "явки" по номеру блока регистрации избирателей, где также наблюдаются аномалии.
* Распределение задержек между транзакцией авторизации ключа избирателя и транзакцией голосования.
...
Для построения графика распределение задержек между транзакцией авторизации ключа избирателя и транзакцией голосования:
```console
./authtime_plot.py --dbname v2021_party
```
